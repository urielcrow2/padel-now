...
const PerfilScreen = ()=>{
 ...
 /*********************Controlamos la lista torneos*********************/
    ...
    return(
        ...
        {/* Sólo para usuario jugador, no es para administradores */}
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-12 mb-5" style={{position:"relative"}}>
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <select className="form-control text-uppercase" onChange={onChangeTournament} disabled={data.load} value={idTournament}>
                                                {
